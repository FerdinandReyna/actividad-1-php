...
<header>
  ...
  <div class="container-fluid">
    ...
    <input type="text" name="txt_direccion" id="txt_direccion"  class="form-control" placeholder="Ejemplo:Lote 10 mz C zona 2"require>
    <label for="lbl_telefono" class="form-label"><b>Telefono</label>
    <input type="number" name="txt_telefono" id="txt_telefono"  class="form-control" placeholder="Ejemplo:74859632"require>
    <label for="lbl_fn" class="form-label"><b>Nacimiento</label>
    <input type="date"  name="txt_fn" id="txt_fn"  class="form-control" placeholder="Ejemplo:01/01/2000"require>
